...
mydatastore.o: mydatastore.cpp mydatastore.h datastore.h product_parser.h db_parser.h util.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c mydatastore.cpp


stringParserTest: stringParserTest.o util.o
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ $^

stringParserTest.o: stringParserTest.cpp util.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c stringParserTest.cpp


clean:
	rm -f *.o amazon stringParserTest
